...
BuildRequires: make
BuildRequires: xtreamui-docbook-style-xsl
BuildRequires: xtreamui-libxslt
BuildRequires: xtreamui-util-linux, xtreamui-flex

# We rely heavily on the DocBook XSL stylesheets!
Requires: xtreamui-docbook-style-xsl
Requires: xtreamui-libxslt
Requires: xtreamui-docbook-dtds
Requires: xtreamui-util-linux, xtreamui-flex
