...
Patch1: gettext-%{version}-disable-libtextstyle.patch
Patch2: gettext-%{version}-covscan.patch
...
BuildRequires: xtreamui-ncurses
BuildRequires: xtreamui-libxml2
BuildRequires: xtreamui-glib2
BuildRequires: xtreamui-libacl
BuildRequires: xtreamui-libunistring
# for the tests
BuildRequires: xtreamui-glibc
