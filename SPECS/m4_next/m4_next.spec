...
mkdir -p $RPM_BUILD_ROOT%{_libexecdir}/%{name}/bin
mv $RPM_BUILD_ROOT%{_bindir}/m4 $RPM_BUILD_ROOT%{_libexecdir}/%{name}/bin
ln -s %{_libexecdir}/%{name}/bin/m4 $RPM_BUILD_ROOT%{_bindir}/%{name}
rename m4.1 %{name}.1 $RPM_BUILD_ROOT%{_mandir}/man1/*
rename m4.info %{name}.info $RPM_BUILD_ROOT%{_infodir}/*

mkdir -p %{buildroot}/usr/share/Modules/modulefiles/m4
cat > %{buildroot}/usr/share/Modules/modulefiles/m4/%{version} <<ENDPY
#%Module

# NOTE: This is an automatically-generated file!  (generated by the
# cmake28 RPM).  Any changes made here will be lost a) if the RPM is
# uninstalled, or b) if the RPM is upgraded or uninstalled.

proc ModulesHelp { } {
   puts stderr "This module adds %{name} to relevant paths"
}

module-whatis   "Sets up m4 %{version} as default in your environment"


prepend-path PATH "%{_libexecdir}/%{name}/bin"
ENDPY
...
%files
%doc COPYING AUTHORS ChangeLog NEWS README THANKS TODO
%{_bindir}/%{name}
%{_infodir}/*
%{_mandir}/man1/%{name}.1*
%{_libexecdir}/%{name}
%dir /usr/share/Modules/modulefiles/m4
/usr/share/Modules/modulefiles/m4/%{version}
