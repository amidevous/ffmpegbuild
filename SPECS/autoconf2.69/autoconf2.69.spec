...
Patch1:     https://raw.githubusercontent.com/amidevous/ffmpegbuild/main/SPECS/autoconf2.69/autoconf-2.69-perl-5.22-autoscan.patch
...
BuildRequires:      m4_next >= 1.4.14
Requires:           m4_next >= 1.4.14
...
pushd %{buildroot}%{_libexecdir}/%{name}/bin
  for i in $(ls); do
    ln -s %{_libexecdir}/%{name}/bin/$i %{buildroot}%{_bindir}/$i
    ln -s $i ./$(echo $i | sed 's/-%{version}//g')
  done
popd


mkdir -p %{buildroot}/usr/share/Modules/modulefiles/autoconf
cat > %{buildroot}/usr/share/Modules/modulefiles/autoconf/%{version} <<ENDPY
#%Module

# NOTE: This is an automatically-generated file!  (generated by the
# autoconf RPM).  Any changes made here will be lost a) if the RPM is
...
module-whatis   "Sets up autoconf %{version} as default in your environment"
...
%dir %{_datadir}/Modules/modulefiles/autoconf
%{_datadir}/Modules/modulefiles/autoconf/%{version}
