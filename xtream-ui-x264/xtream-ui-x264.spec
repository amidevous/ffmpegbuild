...
Name: xtream-ui-x264
Version: xtream-ui-x264version
Release: 1%{?dist}
Source: https://code.videolan.org/videolan/x264/-/archive/stable/x264-stable.tar.gz
License: ASL 2.0
URL: https://gnu.org
BuildRequires: xtream-ui-yasm
Requires: xtream-ui-yasm
%description
